...
namespace KaiiCosmeticosSistema.Controllers
{
    public class EnderecoesController : Controller
    {
        ...
        public EnderecoesController(KaiiCosmeticosSistemaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdEndereco,Logradouro,Numero,Complemento,Bairro,Municipio,Estado,Uf,Cep")] Endereco endereco)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdEndereco,Logradouro,Numero,Complemento,Bairro,Municipio,Estado,Uf,Cep")] Endereco endereco)
        {
