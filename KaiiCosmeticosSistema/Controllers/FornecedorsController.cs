...
namespace KaiiCosmeticosSistema.Controllers
{
    public class FornecedorsController : Controller
    {
        ...
        public FornecedorsController(KaiiCosmeticosSistemaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdFornecedor,RazãoSocial,NomeFantasia,InsEstadual,Cnpj,Email,OrgExpeditor,Tipo,Situacao,Telefone,IdEndereco")] Fornecedor fornecedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdFornecedor,RazãoSocial,NomeFantasia,InsEstadual,Cnpj,Email,OrgExpeditor,Tipo,Situacao,Telefone,IdEndereco")] Fornecedor fornecedor)
        {
